...
const DEFAULT_TERRAIN_STRATEGY_SCRIPT = preload("res://scripts/WorldGen/Terrain/default_terrain_strategy.gd")
const VOXEL_ATLAS_SETTINGS_SCRIPT = preload("res://scripts/WorldGen/voxel_atlas_settings.gd")
const VOXEL_GENERATION_CONTEXT_SCRIPT = preload("res://scripts/WorldGen/voxel_generation_context.gd")
